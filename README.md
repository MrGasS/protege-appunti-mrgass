### Vari appunti personali per comprendere [Protégé](https://protege.stanford.edu/)
<h4>CAPITOLI</h4>

1. [Breve introduzione all'OWL e installazione di Protégé](chapters/01_intro_owl_protege_setup.md)
2. [Creazione di un'ontologia in Protégé](chapters/02_creazione_ontologia.md)
3. [Creazione delle Classi di un'ontologia (gerarchia)](chapters/03_creazione_classi.md)
...
/ Questi appunti non sono un tutorial     \
| completo di Protégé, né approfondiscono |
| RDF o OWL.                              |
\ Potrebbero esserci imprecisioni.        /
 -----------------------------------------
        \   /
         \ /
</code><br>
